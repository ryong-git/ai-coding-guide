...
export default function EcosystemPage() {
  return (
    <div className="prose prose-lg max-w-none dark:prose-invert">
      <PageTitle sectionNumber="2.5">클라우드 운영 산업 생태계</PageTitle>
      ...
      <Paragraph>
        클라우드 운영 산업 생태계의 전망을 파악했다면, <strong>3.1 IT 역할의 진화</strong>에서 
        AI 시대에 맞는 IT 전문가의 새로운 역할과 기회를 살펴보겠습니다.
      </Paragraph>
      ...
      <div className="flex gap-4 mt-8">
        ...
        <a 
          href="/part2/verification-and-systems-thinking/"
